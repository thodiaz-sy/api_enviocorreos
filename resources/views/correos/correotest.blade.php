								...
								<table class="table table-bordered table-content">
									...
									<tbody>
									  ...
									  <tr>
										...
										<th class="text-left">Folio</th><td>{{$data['nombre']}}</td>

									  </tr>

									  <tr>

										<th class="text-left">Tipo</th><td>{{$data['mensaje']}}</td>
									  ...
									  <tr>
										...
										<th class="text-left">Área asociada</th><td>{{$data['nombre']}}</td>

									  </tr>

									  <tr>

										<th class="text-left">Vía de respuesta</th><td>{{$data['nombre']}}</td>

									  </tr>

									  <tr>

										<th class="text-left">Relato del hecho</th><td>{{$data['nombre']}}</td>

									  </tr>

									  <tr>

										<th class="text-left">Peticiones concretas</th><td>{{$data['nombre']}}</td>
