...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
    ...
    <div style="max-width: 800px; margin: 0 auto;" class="email-container">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <td valign="top" class="bg_white" style="padding: 2em 2.5em 0 2.5em;">
          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		...
          		<tr>
					...
					<img src='https://www.padremariano.com/assets/img/LogoPM.png' alt="logoBase" style="width: 100px;"/>
            	...
            	<tr>
            		...
            		<td style="padding: 0 2.5em; text-align: center; padding-bottom: 1em;">
            			...
            			<div class="text">
            				...
            				<h3>Estimado(a) <?php echo e($data['nombre']); ?> </h3>
								...
								<table class="table table-bordered table-content">
									...
									<tbody>
									  ...
									  <tr>
										...
										<th class="text-left">Folio</th><td><?php echo e($data['nombre']); ?></td>

									  </tr>

									  <tr>

										<th class="text-left">Tipo</th><td><?php echo e($data['mensaje']); ?></td>
									  ...
									  <tr>
										...
										<th class="text-left">Área asociada</th><td><?php echo e($data['nombre']); ?></td>

									  </tr>

									  <tr>

										<th class="text-left">Vía de respuesta</th><td><?php echo e($data['nombre']); ?></td>

									  </tr>

									  <tr>

										<th class="text-left">Relato del hecho</th><td><?php echo e($data['nombre']); ?></td>

									  </tr>

									  <tr>

										<th class="text-left">Peticiones concretas</th><td><?php echo e($data['nombre']); ?></td>
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <td class="bg_light" style="text-align: center;font-size: 15px;">
          	...
          	<p>Atentamente <span style="color: #0e4194;">Plataforma OIRS - Centro Odontológico Padre Mariano</span></p>
...
<?php /**PATH C:\Users\Info-Web\Desktop\api_enviocorreos\resources\views/correos/correotest.blade.php ENDPATH**/ ?>